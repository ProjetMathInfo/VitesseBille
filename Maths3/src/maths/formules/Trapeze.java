...
public class Trapeze implements Composite{
	...
	public Object[][] calculComposite(int n, Fonction fx){
		...
		for(int k=0;k<n+1;k++){
			CalculIntegrale c=new CalculIntegrale(fx, new Trapeze());
			tableau[k]=new Object[]{k,c.valeurIntegraleComposite(fx,0.0,1.0,k)};
		}
		/*while(j<n){
